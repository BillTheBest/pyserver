...
class KademliaProtocol(protocol.DatagramProtocol):
    ...
    def __init__(self, node, msgEncoder=encoding.GPGBencode(), msgTranslator=msgformat.DefaultFormat()):
        self._node = node
    ...
    def datagramReceived(self, datagram, address):
        ...
        if datagram[0] == '\x00' and datagram[25] == '\x00':
            ...
            if len(self._partialMessages[msgID]) == totalPackets:
                ...
                return
        try:
            fingerprint, msgPrimitive = self._encoder.decode(datagram, self._node.keyring)
